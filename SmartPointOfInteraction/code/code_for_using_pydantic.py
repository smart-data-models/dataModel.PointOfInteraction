...
class Type12(Enum):
    SmartPointOfInteraction = 'SmartPointOfInteraction'


class SmartPointOfInteraction(BaseModel):
    address: Optional[Address] = Field(None, description='The mailing address')
    alternateName: Optional[str] = Field(
        None, description='An alternative name for this item'
    )
    applicationUrl: Optional[AnyUrl] = Field(
        None,
    ...
    type: Optional[Type12] = Field(
        None, description='NGSI Entity type. It has to be SmartPointOfInteraction'
    )
